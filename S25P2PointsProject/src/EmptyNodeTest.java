...
public class EmptyNodeTest extends TestCase {
    ...
    public void testRemoveByName() {
        KVPair<QuadNode, Point> result = emptyNode.remove("TestPoint", 0, 0, 1024);
    ...
    public void testRegionsearch() {
        ...
        int visited = emptyNode.regionsearch(50, 50, 100, 100, 0, 0, 1024, results);
    ...
    public void testParameterEdgeCases() {
        PointList results = new PointList();
        int visited = emptyNode.regionsearch(Integer.MAX_VALUE, Integer.MAX_VALUE, 
                                             100, 100, 0, 0, 1024, results);
    ...
    public void testBoundaryValues() {
        PointList results = new PointList();
        int visited = emptyNode.regionsearch(50, 50, 100, 100, 0, 0, 0, results);
        assertEquals(1, visited);
