...
public class LeafNodeTest extends TestCase {
    ...
    /**
     * Tests the constructor to ensure it properly initializes an empty leaf node.
     */
    ...
    /**
     * Tests the remove method with coordinates, removing one of multiple points.
     */
    ...
    public void testRemoveByName() {
        ...
        KVPair<QuadNode, Point> result = leafNode.remove("ToRemove", 0, 0, 1024);
    ...
    public void testRemoveByNameNonExistent() {
        ...
        KVPair<QuadNode, Point> result = leafNode.remove("NonExistent", 0, 0, 1024);
    ...
    public void testRegionsearch() {
        ...
        int visited = leafNode.regionsearch(90, 190, 100, 100, 0, 0, 1024, results);
    ...
    public void testRegionsearchNoMatches() {
        ...
        PointList results = new PointList();
        int visited = leafNode.regionsearch(900, 900, 100, 100, 0, 0, 1024, results);
    ...
    public void testShouldSplitWithMoreThanThreePointsDifferentLocations() {
        ...
        QuadNode result = leafNode.insert(new Point("P4", 700, 800), 0, 0, 1024);
