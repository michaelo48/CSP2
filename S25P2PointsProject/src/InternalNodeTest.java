...
public class InternalNodeTest extends TestCase {
    ...
    public void testRemoveByCoordinates() {
        ...
        KVPair<QuadNode, Point> result = internalNode.remove(200, 200, 0, 0, 1024);
    ...
    public void testRemoveByName() {
        ...
        KVPair<QuadNode, Point> result = internalNode.remove("ToRemove", 0, 0, 1024);
    ...
    public void testRemoveNonExistentByName() {
        KVPair<QuadNode, Point> result = internalNode.remove("NonExistent", 0, 0, 1024);
    ...
    public void testRegionsearch() {
        ...
        int visited = internalNode.regionsearch(50, 50, 100, 100, 0, 0, 1024, results);
    ...
    public void testRegionsearchNoIntersection() {
        ...
        PointList results = new PointList();
        int visited = internalNode.regionsearch(500, 500, 100, 100, 0, 0, 1024, results);
